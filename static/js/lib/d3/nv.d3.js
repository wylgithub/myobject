...
(function() {
  ...
  */
  ...
  //Global epiao_utility function to render a tooltip on the DOM.
  ...
  nv.tooltip.calcTooltipPosition = function(pos, gravity, dist, container) {
    ...
    //Global epiao_utility function to remove tooltips from the DOM.
      ...
      if (!rescaleY) {
        var seriesDomains = data
          ...
          .map(function(series,i) {
            ...
            //epiao_account for series being disabled when losing 95% or more
...
nv.models.discreteBar = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      // If showValues, pad the Y axis range to epiao_account for label height
